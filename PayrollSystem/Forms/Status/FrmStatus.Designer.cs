namespace PayrollSystem.Forms.Status
{
    partial class FrmStatus
    {
        ...
        private void InitializeComponent()
        {
            ...
            BtnNewStatus = new FontAwesome.Sharp.IconButton();
            BtnDeleteStatus = new FontAwesome.Sharp.IconButton();
            ...
            // BtnNewStatus
            // 
            BtnNewStatus.BackColor = Color.White;
            BtnNewStatus.FlatAppearance.BorderSize = 0;
            BtnNewStatus.FlatStyle = FlatStyle.Flat;
            BtnNewStatus.Font = new Font("Lucida Sans Unicode", 15.75F, FontStyle.Bold, GraphicsUnit.Point);
            BtnNewStatus.ForeColor = Color.Black;
            BtnNewStatus.IconChar = FontAwesome.Sharp.IconChar.PlusSquare;
            BtnNewStatus.IconColor = Color.YellowGreen;
            BtnNewStatus.IconFont = FontAwesome.Sharp.IconFont.Solid;
            BtnNewStatus.IconSize = 29;
            BtnNewStatus.ImageAlign = ContentAlignment.MiddleLeft;
            BtnNewStatus.Location = new Point(380, 116);
            BtnNewStatus.Name = "BtnNewStatus";
            BtnNewStatus.Size = new Size(114, 30);
            BtnNewStatus.TabIndex = 10;
            BtnNewStatus.Text = "New";
            BtnNewStatus.UseVisualStyleBackColor = false;
            BtnNewStatus.Click += BtnNewStatus_Click;
            // 
            // BtnDeleteStatus
            // 
            BtnDeleteStatus.BackColor = Color.White;
            BtnDeleteStatus.FlatAppearance.BorderSize = 0;
            BtnDeleteStatus.FlatStyle = FlatStyle.Flat;
            BtnDeleteStatus.Font = new Font("Lucida Sans Unicode", 15.75F, FontStyle.Bold, GraphicsUnit.Point);
            BtnDeleteStatus.ForeColor = Color.Black;
            BtnDeleteStatus.IconChar = FontAwesome.Sharp.IconChar.SquareMinus;
            BtnDeleteStatus.IconColor = Color.Red;
            BtnDeleteStatus.IconFont = FontAwesome.Sharp.IconFont.Solid;
            BtnDeleteStatus.IconSize = 29;
            BtnDeleteStatus.ImageAlign = ContentAlignment.MiddleLeft;
            BtnDeleteStatus.Location = new Point(527, 116);
            BtnDeleteStatus.Name = "BtnDeleteStatus";
            BtnDeleteStatus.Size = new Size(147, 30);
            BtnDeleteStatus.TabIndex = 11;
            ...
            LabelTotalStatus.Font = new Font("Microsoft Sans Serif", 15.75F, FontStyle.Regular, GraphicsUnit.Point);
            LabelTotalStatus.Location = new Point(280, 192);
            LabelTotalStatus.Name = "LabelTotalStatus";
            LabelTotalStatus.Size = new Size(60, 25);
            LabelTotalStatus.TabIndex = 13;
            LabelTotalStatus.Text = "Total";
            // 
            // DataList
            // 
        ...
        private FontAwesome.Sharp.IconButton BtnNewStatus;
        private FontAwesome.Sharp.IconButton BtnDeleteStatus;
